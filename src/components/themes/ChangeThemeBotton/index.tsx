...
const ChangeThemeButton = () => {
  ...
  return (
    <View
      style={[
        { position: "absolute", display: 'flex', alignItems:'center', justifyContent: 'center', top: 7, right: 15, height: 45, width: 45, borderRadius: 5, backgroundColor: selectedTheme.transporentButton  },
        Platform.select({
          ios: {  top: 45, right: 20, height: 40, width: 40, padding: 2 },
        }),
